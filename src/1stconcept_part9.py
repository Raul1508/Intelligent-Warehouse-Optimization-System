...
Corridor.insert(0, "Corridor Length")
...
def area():
    ...
    if ID == 0:
        ...
        if width_p < long_p:
            ...
            if (pos_width_p < collide_I_w) & (pos_long_p == collide_I_l):
            ...
            if (pos_width_p < collide_II_w) & (pos_long_p == collide_II_l):
        ...
        #     if (pos_long_p_x <= remains_l):
        #         result_distance = abs(int(remains_w+layout_long-remains_l+looseness_corridor_l))
        #     else:
        #         result_distance = abs(int(remains_w+layout_long-remains_l-width_p))
        ...
        #         result_distance = abs(int(remains_w+layout_long-remains_l+looseness_corridor_l))
        #     else:
        #         result_distance = abs(int(remains_w+layout_long-remains_l-long_p))
        ...
        #     if (pos_long_p_x <= collide_I_l):
        #         result_distance_I = abs(int(collide_I_w+layout_long-collide_I_l+looseness_corridor_l))
        #     else:        
        #         result_distance_I = abs(int(collide_I_w+layout_long-collide_I_l-width_p))

        #     if (pos_long_p_x <= collide_II_l):
        #         result_distance_II = abs(int(collide_II_w+layout_long-collide_II_l+looseness_corridor_l))
        #     else:
        #         result_distance_II = abs(int(collide_II_w+layout_long-collide_II_l-width_p))
        
        # else:

        #     if (pos_width_p_x <= collide_I_w):
        #         result_distance_I = abs(int(collide_I_w+layout_long-collide_I_l+looseness_corridor_l))
        #     else:        
        #         result_distance_I = abs(int(collide_I_w+layout_long-collide_I_l-long_p))

        #     if (pos_width_p_x <= collide_II_w):
        #         result_distance_II = abs(int(collide_II_w+layout_long-collide_II_l+looseness_corridor_l))
        #     else:
        #         result_distance_II = abs(int(collide_II_w+layout_long-collide_II_l-long_p))
        ...
        if (min_collide_result == "Type_I") & (result_distance_I < remains_result_distance):
            min_distance_w = collide_I_w
            min_distance_l = collide_I_l
        elif (min_collide_result == "Type_II") & (result_distance_II < remains_result_distance):
            min_distance_w = collide_II_w
            min_distance_l = collide_II_l
        else:
...
def open_py_file(): 
    ...
    # Create a zip file
    with zipfile.ZipFile('Autonomous_Multilayer_Areas.zip', 'w') as zip_file:
        # Add each image to the zip file
        for image_path in thislist:
            # Add the image file to the zip file with its original name
            zip_file.write(image_path, os.path.basename(image_path))

    thislist.append('Autonomous_Multilayer_Areas.zip')

    call(["python","1stconcept_part13.py"])
